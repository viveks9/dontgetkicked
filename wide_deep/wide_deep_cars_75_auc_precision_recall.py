...
#  ]
  ...
  deep_columns = [
      ...
      #tf.feature_column.indicator_column(buyer_no),
...
def main(argv):
  ...
  train_file = os.path.join(flags.data_dir, 'bigger_cars_train.csv')
  test_file = os.path.join(flags.data_dir, 'bigger_cars_validate.csv')
