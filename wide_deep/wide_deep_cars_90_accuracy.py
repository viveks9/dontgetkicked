...
_CSV_COLUMNS = [
    ...
    'vin_state', 'vehb_cost', 'is_online_sale', 'warranty_cost'
]
...
def build_model_columns():
  ...
  odo_buckets = tf.feature_column.bucketized_column(
      vehicle_odometer, boundaries=[5000, 10000, 20000, 40000, 60000, 80000, 100000, 120000, 140000, 160000, 180000, 200000, 220000, 240000, 260000])
...
#  ]
  ...
  crossed_columns = [
      ...
      #    ['vehicle_make', 'vehicle_model'], hash_bucket_size=1000),
      #tf.feature_column.crossed_column(
...
def main(argv):
  ...
  train_file = os.path.join(flags.data_dir, 'cars_train_final_90.csv')
  test_file = os.path.join(flags.data_dir, 'cars_validate_final_10.csv')
